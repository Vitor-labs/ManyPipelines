CREATE TABLE Dim_Recalls IF NOT EXISTS (
    ...
    EXTRACTED_DATE DATE -- Datelike string: mm/dd/yyyy
		CHECK(lenght(EXTRACTED_DATE) == 10), 
) WITHOUT ROWID;

CREATE TABLE Dim_Grid IF NOT EXISTS (
...
CREATE TABLE Dim_Warraties IF NOT EXISTS (
...
CREATE TABLE Dim_Complaints IF NOT EXISTS (
